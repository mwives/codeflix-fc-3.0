...
} from '@core/category/domain/nested-category.entity';
import {
  NestedGenre,
  NestedGenreConstructorProps,
} from '@core/genre/domain/nested-genre.entity';
...
export class Video extends AggregateRoot {
  ...
  toJSON() {
    return {
      ...
      thumbnail_half_url: this.thumbnail_half_url
        ? this.thumbnail_half_url
        : null,
